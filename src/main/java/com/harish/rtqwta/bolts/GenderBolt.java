...
public class GenderBolt implements IRichBolt {
	...
	public void execute(Tuple input) {
		...
		String gender = patientDetails.getPatient_gender();
		long waitingTime = patientDetails.getWaitingTime();
		long treatmentTime = patientDetails.getTreatmentTime();
		
		Analysis analysis = new Analysis();
		analysis.setCategory(CommonConstants.Analysis.Category.GENDER);
		if(gender.equalsIgnoreCase(CommonConstants.Analysis.SubCategory.MALE)){
			analysis.setSub_category(CommonConstants.Analysis.SubCategory.MALE);
		} else if(gender.equalsIgnoreCase(CommonConstants.Analysis.SubCategory.FEMALE)){
			analysis.setSub_category(CommonConstants.Analysis.SubCategory.FEMALE);
		} else{
			analysis.setSub_category(CommonConstants.Analysis.SubCategory.OTHERS);
		} 
