...
<html>
	<head>
		...
		<script>
	        ...
	        mainApp.controller('historicalTreatmentCompletedView', function($scope, $http) {
	        	var url = "getHistoricalTreatmentCompletedPatientList";
		...
		<nav class="navbar navbar-inverse">
			<div class="container-fluid">
				<ul class="nav navbar-nav">
					...
					<li class="active"><a href="historicalTreatmentCompleted.jsp">Historical Complete Treatment</a></li>
				</ul>
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div ng-app="mainApp" ng-controller="historicalTreatmentCompletedView" class="modal-body">
